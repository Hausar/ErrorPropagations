...
void Thesis_Rebin_test_average_v5Linear() {    
    ...
    Rebin_Ratio_9->Sumw2();
    //==========================================================================
    //Open V5Linear Debug new version:
    TFile *file = TFile::Open("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/AllGaps_Linear_NL_V4_V5/AllGaps_V422_NL_Linear_NUA+NUE/V4_V5_Linear_Debug/4particle_newDebug_V4_V5_Linear.root", "READ");
    if(!file) return; 
    hCLinear_Gap00 = (TH1D*)file->Get("V4_Linear_Gap00_A+B");
    hCLinear_Gap01 = (TH1D*)file->Get("V4_Linear_Gap01_A+B");
    hCLinear_Gap02 = (TH1D*)file->Get("V4_Linear_Gap02_A+B"); 
    hCLinear_Gap03 = (TH1D*)file->Get("V4_Linear_Gap03_A+B");
    hCLinear_Gap04 = (TH1D*)file->Get("V4_Linear_Gap04_A+B");
    hCLinear_Gap05 = (TH1D*)file->Get("V4_Linear_Gap05_A+B");
    hCLinear_Gap06 = (TH1D*)file->Get("V4_Linear_Gap06_A+B");
    hCLinear_Gap07 = (TH1D*)file->Get("V4_Linear_Gap07_A+B");
    hCLinear_Gap08 = (TH1D*)file->Get("V4_Linear_Gap08_A+B");
    //==========================================================================
    int binning = 10;
    double errorNum;
    double sumNum = 0;
    ...
    if(binning == 10)RebinAll(hCLinear_Gap07, Rebin_Ratio_8, 10);
    if(!hCLinear_Gap07) fPrint("Warning there is no histogram");

    if(binning == 10)RebinAll(hCLinear_Gap08, Rebin_Ratio_9, 10);
    if(!hCLinear_Gap08) fPrint("Warning there is no histogram");
    //..Writting to the Root.file:
    //..V4_Linear
    TFile* fileOutput = new TFile("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/AllGaps_Linear_NL_V4_V5/AllGaps_V422_NL_Linear_NUA+NUE/V4_V5_Linear_Debug/Rebin_4particle_newDebug_V4_V5_Linear_Helene.root","UPDATE");
    if(!fileOutput) return;
    fileOutput->cd();
    Rebin_Ratio_1->Write("Rebin_V4_Linear_Gap00_A+B");
    Rebin_Ratio_2->Write("Rebin_V4_Linear_Gap01_A+B");
    Rebin_Ratio_3->Write("Rebin_V4_Linear_Gap02_A+B"); 
    Rebin_Ratio_4->Write("Rebin_V4_Linear_Gap03_A+B");
    Rebin_Ratio_5->Write("Rebin_V4_Linear_Gap04_A+B");
    Rebin_Ratio_6->Write("Rebin_V4_Linear_Gap05_A+B");
    Rebin_Ratio_7->Write("Rebin_V4_Linear_Gap06_A+B");
    Rebin_Ratio_8->Write("Rebin_V4_Linear_Gap07_A+B");
    Rebin_Ratio_9->Write("Rebin_V4_Linear_Gap08_A+B");    
} // End of the Macro
