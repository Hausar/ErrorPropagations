...
{    
    ...
    TH1D* Rebin_hCLinear_Gap01A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap01A");
    TH1D* Rebin_hCLinear_Gap02A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap02A");
    TH1D* Rebin_hCLinear_Gap03A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap03A");
    TH1D* Rebin_hCLinear_Gap04A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap04A");
    TH1D* Rebin_hCLinear_Gap05A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap05A");
    TH1D* Rebin_hCLinear_Gap06A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap06A");
    TH1D* Rebin_hCLinear_Gap07A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap07A");
    TH1D* Rebin_hCLinear_Gap08A = (TH1D*)fileOutput->Get("Rebin_hCLinear_Gap08A");
    ...
    //Rebin_hCLinear_Gap00A->SetFillColor(kRed-9);
    ...
    Rebin_hCLinear_Gap02A->SetMarkerColor(kSpring);
    Rebin_hCLinear_Gap02A->SetLineColor(kSpring+1);
    ...
    // leg01->AddEntry(Rebin_hCLinear_Gap01A, "v_{4,22} Gap = 0.1 A");
    //leg01->Draw("same");
