...
{    
    ...
    Rebin_Ratio_9->Sumw2();
    //==========================================================================
    TFile *file = TFile::Open("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/AllGaps_Linear_NL_V4_V5/AllGaps_V422_NL_Linear_NUA+NUE/V5_V4_{2}/V5_V4_2particle_NUA+NUE.root", "READ");

    if(!file) return; 
    v532_Gap00 = (TH1D*)file->Get("V4_2particle_Gap00_A+B");
    v532_Gap01 = (TH1D*)file->Get("V4_2particle_Gap01_A+B");
    v532_Gap02 = (TH1D*)file->Get("V4_2particle_Gap02_A+B"); 
    v532_Gap03 = (TH1D*)file->Get("V4_2particle_Gap03_A+B");
    v532_Gap04 = (TH1D*)file->Get("V4_2particle_Gap04_A+B");
    v532_Gap05 = (TH1D*)file->Get("V4_2particle_Gap05_A+B");
    v532_Gap06 = (TH1D*)file->Get("V4_2particle_Gap06_A+B");
    v532_Gap07 = (TH1D*)file->Get("V4_2particle_Gap07_A+B");
    v532_Gap08 = (TH1D*)file->Get("V4_2particle_Gap08_A+B");
    //==========================================================================
    int binning = 10;
    double errorNum;
    double sumNum = 0;
    ...
    TFile* fileOutput = new TFile("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/AllGaps_Linear_NL_V4_V5/AllGaps_V422_NL_Linear_NUA+NUE/V5_V4_{2}/Rebin_V5_V4_2particle_NUA+NUE.root","UPDATE");
    if(!fileOutput) return;
    fileOutput->cd();
    Rebin_Ratio_1->Write("Rebin_V4_2particle_Gap00_A+B");
    Rebin_Ratio_2->Write("Rebin_V4_2particle_Gap01_A+B");
    Rebin_Ratio_3->Write("Rebin_V4_2particle_Gap02_A+B"); 
    Rebin_Ratio_4->Write("Rebin_V4_2particle_Gap03_A+B");
    Rebin_Ratio_5->Write("Rebin_V4_2particle_Gap04_A+B");
    Rebin_Ratio_6->Write("Rebin_V4_2particle_Gap05_A+B");
    Rebin_Ratio_7->Write("Rebin_V4_2particle_Gap06_A+B");
    Rebin_Ratio_8->Write("Rebin_V4_2particle_Gap07_A+B");
    Rebin_Ratio_9->Write("Rebin_V4_2particle_Gap08_A+B");
} // End of the Macro
