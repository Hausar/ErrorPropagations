...
void Rebin_GapA_GapB() {    
    ...
    v422_Gap02 = (TH1D*)file->Get("v422_Gap02_A+B"); 
    v422_Gap03 = (TH1D*)file->Get("v422_Gap03_A+B");
    v422_Gap04 = (TH1D*)file->Get("v422_Gap04_A+B");
    v422_Gap05 = (TH1D*)file->Get("v422_Gap05_A+B");
    ...
    Rebin_Ratio_2->Write("Rebin_v422_Gap01_A+B");
    Rebin_Ratio_3->Write("Rebin_v422_Gap02_A+B"); 
    Rebin_Ratio_4->Write("Rebin_v422_Gap03_A+B");
    Rebin_Ratio_5->Write("Rebin_v422_Gap04_A+B");
