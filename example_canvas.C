...
//Author; Rene Brun
  ...
  //  TH2F *h4 = new TH2F("h4","test4",6,20,80,20,0,1000);
   ...
   gPad->SetTickx(2);
    ...
    Rebin_Chi_V422_Gap00A->GetYaxis()->SetRangeUser(-0.8, 6.5);
    Rebin_Chi_V422_Gap00A->GetYaxis()->SetTitleOffset(0.4);
    ...
    Rebin_Chi_V422_Gap00A->GetYaxis()->SetTitleSize(0.08);
    ...
    Rebin_Chi_V422_Gap02A->SetMarkerStyle(kFullCircle); 
    ...
    Rebin_Chi_V422_Gap05A->SetMarkerColor(kOrange+1);
    Rebin_Chi_V422_Gap05A->SetLineColor(kOrange+1);
    ...
    Rebin_Chi_V422_Gap08A->SetMarkerColor(kMagenta+1);
    Rebin_Chi_V422_Gap08A->SetLineColor(kMagenta+1);
    ...
    latex.DrawLatex(23,6.1,"ALICE");

    latex.SetTextSize(0.048);
    latex.SetTextAlign(13);  //align at top
    latex.DrawLatex(23,5.6,"p-Pb collisions (This Thesis)");
    
    latex.SetTextSize(0.048);
    latex.SetTextAlign(13);  //align at top
    latex.DrawLatex(23,5.,"#sqrt{s_{NN}} = 5.02 TeV");

    latex.SetTextAlign(13);  //centered
    latex.DrawLatex(23,4.4,"|#eta| < 0.8");

    latex.SetTextAlign(13);  //centered
    latex.DrawLatex(23,3.8," 0.2 < p_{T} < 3.0 GeV/c");

    TLegend *leg = new TLegend(0.22, 0.02, 0.39, 0.38); 
    //TLegend *leg = new TLegend(0.65 , 0.2, 0.89, 0.39); 
    leg->AddEntry(Rebin_Chi_V422_Gap00A, "|#Delta#eta| > 0.0", "lep");
    leg->AddEntry(Rebin_Chi_V422_Gap01A, "|#Delta#eta| > 0.1", "lep");
   ...
   gPad->SetTicky(2);
    ...
    Rebin_Chi_V532_Gap00A->GetYaxis()->SetRangeUser(-0.8, 6.5);
    ...
    Rebin_Chi_V532_Gap05A->SetMarkerColor(kOrange+1);
    Rebin_Chi_V532_Gap05A->SetLineColor(kOrange+1);
    ...
    // Rebin_Chi_V532_Gap08A->SetMarkerColor(kMagenta+1);
    ...
    TLegend *leg = new TLegend(0.11, 0.04, 0.3, 0.39); 
    //TLegend *leg = new TLegend(0.65 , 0.2, 0.89, 0.39); 
   ...
   TFile* fileOutput = new TFile("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/Comparison_Katka_Helene_NUA+NUE/Rebin_Plots_Helene_You_Rho422_Rho532/Rebin_RhoV422_Helene.root","READ");
    ...
    Rebin_Rho_V422_Gap00A->GetXaxis()->SetRangeUser(20, 70);
    Rebin_Rho_V422_Gap00A->Draw("P");
    Rebin_Rho_V422_Gap00A->GetYaxis()->SetRangeUser(0.2, 1.42);
    Rebin_Rho_V422_Gap00A->GetYaxis()->SetTitleOffset(0.6);
    Rebin_Rho_V422_Gap00A->GetYaxis()->SetTitleSize(0.06);
    ...
    Rebin_Rho_V422_Gap00A->GetXaxis()->SetTitleOffset(.71);
    Rebin_Rho_V422_Gap00A->GetXaxis()->SetTitleSize(0.06);
    ...
    Rebin_Rho_V422_Gap05A->SetMarkerColor(kOrange+1);
    Rebin_Rho_V422_Gap05A->SetLineColor(kOrange+1);
    ...
    Rebin_Rho_V422_Gap08A->SetMarkerColor(kMagenta+1);
    Rebin_Rho_V422_Gap08A->SetLineColor(kMagenta+1);
   ...
   //h3->Draw();
    ...
    // latex.SetTextAlign(13);  //align at top
    // latex.DrawLatex(23,1.3,"ALICE");

    // latex.SetTextSize(0.045);
    // latex.SetTextAlign(13);  //align at top
    // latex.DrawLatex(23,1.2,"p-Pb collisions (This Thesis)");
   ...
   gPad->SetTicky(2);
    ...
    Rebin_Rho_V532_Gap00A->GetYaxis()->SetRangeUser(0.2, 1.42);
    ...
    Rebin_Rho_V532_Gap00A->GetXaxis()->SetTitleOffset(0.73);
    Rebin_Rho_V532_Gap00A->GetXaxis()->SetTitleSize(0.06);
    ...
    Rebin_Rho_V532_Gap05A->SetMarkerColor(kOrange+1);
    Rebin_Rho_V532_Gap05A->SetLineColor(kOrange+1);
    ...
    // Rebin_Rho_V532_Gap08A->SetMarkerColor(kMagenta+1);
    ...
    // latex.SetTextSize(0.048);
    // latex.SetTextAlign(13);  //align at top
    // latex.DrawLatex(23, 1.3, "#sqrt{s_{NN}} = 5.02 TeV");

    // latex.SetTextAlign(13);  //centered
    // latex.DrawLatex(23, 1.2,"|#eta| < 0.8");

    // latex.SetTextAlign(13);  //centered
    // latex.DrawLatex(23,1.1," 0.2 < p_{T} < 3.0 GeV/c");
    //c1->SaveAs("/Users/Helena/Dropbox/0-Speciale/DFS/Pic/Final_Chi_Rho.png");
}
