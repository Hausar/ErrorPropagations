...
//    t->DrawLatex(0.6,0.85,"Non-uniform acceptance (NUA) corrections of #phi.");
   ...
   //c1->SaveAs("/Users/Helena/Desktop/Helen_simpletask/ErrorPropagations/Comparison_Katka_Helene_NUA+NUE/Ratio_NUA_2D_Weights_EtaPhi/2Dhistogram_EtaPhi_projection.png");
    ...
    TH3F *h3 = (TH3F*)file_NUA->Get("fPhiWeight");
    h3->SetStats(0);
    h3->SetTitle(0);
    ...
    t->DrawLatex(0.6,0.85,"Non-uniform acceptance (NUA) corrections of #phi.");
    c1->SaveAs("/Users/Helena/Desktop/Helen_simpletask/ErrorPropagations/Comparison_Katka_Helene_NUA+NUE/Ratio_NUA_2D_Weights_EtaPhi/3Dhistogram_NUA2_projection.png");
