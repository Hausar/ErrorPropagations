...
void Example_Ratioplots() {
   ...
   TH1D *h2 = new TH1D("h2", "h2", 200, 0, 200);
    ...
    //h1 = Cn42_Gap0->ProjectionX();
    //h1 = Cn43_Gap0->ProjectionX();
    ...
    // if(file2) {
    //     //h2 = (TH1D*)file2->Get("fc422Gap0A"); 
    //     //h2 = (TH1D*)file2->Get("fc532Gap0A");
...
//     h3->Write("Ratio_plots_Helene_You_4particle_2222");
    ...
    //c->SaveAs("/Users/Helena/Desktop/Helen_simpletask/ErrorPropagations/Comparison_Katka_Helene_NUA+NUE/Ratio_Helene_Extra_You_4part_22.png");
