...
void Plot_V4_V5_thesis() {    
    ...
    Rebin_V5_2particle_Gap00->GetYaxis()->SetRangeUser(-0.001,0.05);
    Rebin_V5_2particle_Gap00->GetYaxis()->SetTitleOffset(0.9);
    //Rebin_V5_2particle_Gap00->GetYaxis()->CenterTitle(true);
    Rebin_V5_2particle_Gap00->GetYaxis()->SetTitle("v_{5}{2}");
    Rebin_V5_2particle_Gap00->GetYaxis()->SetTitleSize(0.055);
    Rebin_V5_2particle_Gap00->GetYaxis()->SetNdivisions(505); // sometimes this makes the axes look prettier, it decreases number of ticks
    Rebin_V5_2particle_Gap00->GetYaxis()->SetLabelSize(0.055); // label size should be the same as title size for consistency
    //Rebin_V5_2particle_Gap00->GetXaxis()->SetTitle("N_{ch}");
    Rebin_V5_2particle_Gap00->GetXaxis()->SetRangeUser(20, 90);
    Rebin_V5_2particle_Gap00->GetXaxis()->SetTitleSize(0.055); 
    Rebin_V5_2particle_Gap00->GetXaxis()->SetTitleOffset(1.0);
    //Rebin_V5_2particle_Gap00->GetXaxis()->CenterTitle(true);
    Rebin_V5_2particle_Gap00->GetXaxis()->SetTitle("N_{ch}(|#eta| < 0.8)");
    Rebin_V5_2particle_Gap00->GetXaxis()->SetLabelSize(0.055);
    Rebin_V5_2particle_Gap00->GetXaxis()->SetNdivisions(505); // sometimes this makes the axes look prettier, it decreases number of ticks
    ...
    latex.SetTextSize(0.045);
    latex.SetTextAlign(13);  //centered
    latex.DrawLatex(40,0.049," (This thesis)");
    ...
    canRatio->SaveAs("/Users/Helena/Dropbox/0-Speciale/code/panda/Sand_boks/Old/pic/Plots_V4_V5_2particle/Results_V5_gap00_gap08.pdf");
