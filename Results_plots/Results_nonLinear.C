...
{    
    ...
    //..Open the Root.file:
    TFile* fileOutput = new TFile("/Users/Helena/Dropbox/0-Speciale/code/panda/Thesis_Macros/Helen_simpletask/ErrorPropagations/AllGaps_Linear_NL_V4_V5/AllGaps_V422_NL_Linear_NUA+NUE/Average_V422_NUA+NUE/4particle_Rebin_Debug_Average_v422_v532_A+B.root","READ");

    TH1D* Rebin_hV422_Gap00A = (TH1D*)fileOutput->Get("Rebin_v422_Gap00_A+B");
    TH1D* Rebin_hV422_Gap01A = (TH1D*)fileOutput->Get("Rebin_v422_Gap01_A+B");
    TH1D* Rebin_hV422_Gap02A = (TH1D*)fileOutput->Get("Rebin_v422_Gap02_A+B");
    TH1D* Rebin_hV422_Gap03A = (TH1D*)fileOutput->Get("Rebin_v422_Gap03_A+B");
    TH1D* Rebin_hV422_Gap04A = (TH1D*)fileOutput->Get("Rebin_v422_Gap04_A+B");
    TH1D* Rebin_hV422_Gap05A = (TH1D*)fileOutput->Get("Rebin_v422_Gap05_A+B");
    TH1D* Rebin_hV422_Gap06A = (TH1D*)fileOutput->Get("Rebin_v422_Gap06_A+B");
    TH1D* Rebin_hV422_Gap07A = (TH1D*)fileOutput->Get("Rebin_v422_Gap07_A+B");
    TH1D* Rebin_hV422_Gap08A = (TH1D*)fileOutput->Get("Rebin_v422_Gap08_A+B");
    ...
    Rebin_hV422_Gap00A->GetYaxis()->SetRangeUser(-0.001, 0.03);
    Rebin_hV422_Gap00A->GetYaxis()->SetTitleOffset(1.1);
    ...
    latex.DrawLatex(23,0.028,"ALICE");

    latex.SetTextSize(0.045);
    latex.SetTextAlign(13);  //align at top
    latex.DrawLatex(23,0.025,"p-Pb collisions");
    
    latex.SetTextSize(0.045);
    latex.SetTextAlign(13);  //align at top
    latex.DrawLatex(23,0.022,"#sqrt{s_{NN}} = 5.02 TeV");

    latex.SetTextSize(0.045);
    latex.SetTextAlign(13);  //centered
    latex.DrawLatex(23,0.0192,"|#eta| < 0.8");

    latex.SetTextSize(0.045);
    latex.SetTextAlign(13);  //centered
    latex.DrawLatex(23,0.0163," 0.2 < p_{T} < 3.0 GeV/c");
    
    latex.SetTextSize(0.05);
    latex.SetTextAlign(13);  //align at top
    latex.DrawLatex(35,0.028,"(This thesis)");
    
    TLegend *leg = new TLegend(0.77,0.56,0.92,0.88);
    ...
    canRatio->SaveAs("/Users/Helena/Dropbox/0-Speciale/code/panda/Sand_boks/Old/pic/Plots_NonLinear_V532/Thesis_v422_NonLinear.pdf");
}